...
@EnableWebSecurity
class AdminWebSecurityConfig extends WebSecurityConfigurerAdapter {
	
//	@Autowired
//	private AdminMyUserDetailsService myUserDetailsService;
...
//	}
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable()
				.authorizeRequests().antMatchers("/authenticate","/api/candidate/signup","/candidate/loginuser/{token}").permitAll().
